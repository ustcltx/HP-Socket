...
#include "HttpClient.h"
	...
	#pragma comment(linker, "/EXPORT:SYS_GetIPAddress=_SYS_GetIPAddress@12")
	#pragma comment(linker, "/EXPORT:SYS_GetIPv4InAddr=_SYS_GetIPv4InAddr@4")
	#pragma comment(linker, "/EXPORT:SYS_GetLastError=_SYS_GetLastError@0")
	#pragma comment(linker, "/EXPORT:SYS_GetOptimalIPByHostName=_SYS_GetOptimalIPByHostName@8")
	...
	#pragma comment(linker, "/EXPORT:SYS_IsIPAddress=_SYS_IsIPAddress@4")
...
HPSOCKET_API BOOL __stdcall HP_HttpAgent_SendRequest(HP_HttpAgent pAgent, HP_CONNID dwConnID, LPCSTR lpszMethod, LPCSTR lpszPath, const HP_THeader lpHeaders[], int iHeaderCount, const BYTE* pBody, int iLength)
{
...
{
	return ::GetIPAddress(lpszHost, lpszIP, *piIPLenth);
}
